...
extern inline void FT_Register_Write(uint32 everegister, uint32 value);
extern inline uint32 FT_Register_Read(uint32 everegister);
...
*
*******************************************************************************/
inline void FT_Register_Write(uint32 everegister, uint32 value)
{
...
*
*******************************************************************************/
inline uint32 FT_Register_Read(uint32 everegister)
{
